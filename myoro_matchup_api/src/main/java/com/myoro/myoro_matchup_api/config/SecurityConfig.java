...
public class SecurityConfig {
  ...
  @Autowired private CustomAuthenticationEntryPointComponent customAuthenticationEntryPoint;

  @Autowired private JwtAuthenticationFilterComponent jwtAuthenticationFilter;

  /**
   * Security filter chain.
   *
   * <p>We need to add the endpoints that will not require authentication.
   */
  @Bean
