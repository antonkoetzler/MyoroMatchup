 ...
 * 
 * Provides reusable query specifications for friend request filtering.
 */
public class FriendSpecifications {

  /**
   * Creates a specification to filter friend requests by user (as requester or
   * recipient).
   * 
   ...
   */
  public static Specification<FriendRequestModel> filter(Long userId, String searchQuery,
