...
public interface FriendRequestRepository extends JpaRepository<FriendRequestModel, Long>, JpaSpecificationExecutor<FriendRequestModel> {
   ...
   */
  Optional<FriendRequestModel> findByRequesterIdAndRecipientIdAndStatus(Long requesterId, Long recipientId,
   ...
   * @return list of friend requests
   */
  List<FriendRequestModel> findByRecipientIdAndStatus(Long recipientId, FriendRequestStatusEnum status);
   ...
   */
  boolean existsByRequesterIdAndRecipientIdAndStatus(Long requesterId, Long recipientId,
      FriendRequestStatusEnum status);
}
