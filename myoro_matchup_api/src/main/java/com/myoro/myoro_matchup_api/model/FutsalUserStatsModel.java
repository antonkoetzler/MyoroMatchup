...
/** Futsal user stats model. */
@Entity
@Table(name = "futsal_user_stats")
@DiscriminatorValue("FUTSAL")
@PrimaryKeyJoinColumn(name = "id")
public class FutsalUserStatsModel extends UserStatsModel {
  /** Attack stat. */
  ...
  /** Default constructor. */
  public FutsalUserStatsModel() {
    setSport(SportsEnum.FUTSAL);
  }
   ...
   */
  public FutsalUserStatsModel(UserModel user, Integer rating, Integer attack, Integer defense, Integer striking,
      Integer skills) {
    setUser(user);
    setSport(SportsEnum.FUTSAL);
    setRating(rating);
