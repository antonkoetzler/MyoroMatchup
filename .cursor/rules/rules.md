...
- Never add hard-coded strings into code except for writing errors and exceptions. Already create localization in the frontend with ARB files and backend with `messages_*.properties` files for ALL languages
