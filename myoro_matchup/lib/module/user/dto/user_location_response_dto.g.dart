...
part of 'user_location_response_dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

UserLocationResponseDto _$UserLocationResponseDtoFromJson(Map<String, dynamic> json) => UserLocationResponseDto(
  country: $enumDecode(_$MyoroCountryEnumEnumMap, json['country']),
  state: json['state'] as String?,
  city: json['city'] as String?,
);

Map<String, dynamic> _$UserLocationResponseDtoToJson(UserLocationResponseDto instance) => <String, dynamic>{
...
/// Apply this mixin to [UserLocationResponseDto] once the code is generated.
///
/// ```dart
/// class UserLocationResponseDto with _$UserLocationResponseDtoMixin {}
/// ```
mixin _$UserLocationResponseDtoMixin {
  UserLocationResponseDto get self => this as UserLocationResponseDto;

  UserLocationResponseDto copyWith({
    MyoroCountryEnum? country,
    String? state,
    bool stateProvided = true,
    String? city,
    bool cityProvided = true,
  }) {
    return UserLocationResponseDto(
      country: country ?? self.country,
      state: stateProvided ? (state ?? self.state) : null,
      city: cityProvided ? (city ?? self.city) : null,
    );
  }

  @override
  bool operator ==(Object other) {
    return other is UserLocationResponseDto &&
  ...
  @override
  int get hashCode {
    return Object.hash(self.country, self.state, self.city);
  }
