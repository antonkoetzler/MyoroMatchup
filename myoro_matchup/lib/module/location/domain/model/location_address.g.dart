...
/// Apply this mixin to [LocationAddress] once the code is generated.
///
/// ```dart
/// class LocationAddress with _$LocationAddressMixin {}
/// ```
mixin _$LocationAddressMixin {
  ...
  @override
  int get hashCode {
    return Object.hash(self.city, self.country);
  }
