...
mixin _$GameDetailsScreenThemeExtensionMixin on ThemeExtension<GameDetailsScreenThemeExtension> {
  ...
  GameDetailsScreenThemeExtension copyWith({
    ...
    TextStyle? bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle,
  }) {
    return GameDetailsScreenThemeExtension(
      ...
      bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle:
          bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle ??
          self.bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle,
    );
  }
  ...
  String toString() =>
      ...
      '  bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle: ${self.bodySuccessStateTabViewPlayersTabContentTeamListingNameTextStyle},\n'
      ');';
}
