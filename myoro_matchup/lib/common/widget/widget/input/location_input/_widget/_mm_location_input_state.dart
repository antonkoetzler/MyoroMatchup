...
final class _MmLocationInputState extends State<MmLocationInput> {
  ...
  Widget build(_) {
    ...
    return InheritedProvider.value(
      value: _viewModel,
      child: MyoroSearchDropdown<LocationResponseDto>(
        label: label,
        requestCallback: requestCallback,
        onChanged: onChanged,
        dropdownType: MyoroSearchDropdownDropdownTypeEnum.expanding,
        itemBuilder: (_, item) => MyoroMenuButtonItem(builder: (_, _) => _Item(item), onTapUp: (_, _) {}),
