...
public interface InvitationRepository
   ...
   */
  Optional<InvitationModel> findByGameIdAndInviteeIdAndStatus(
      Long gameId, Long inviteeId, InvitationStatusEnum status);
  ...
  /**
   * Finds all invitations sent by a user (as inviter), optionally filtered by status.
   *
   * @param inviterId the inviter ID
